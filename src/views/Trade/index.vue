<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="(addressList) in address" :key="addressList.id">
        <span
          class="username"
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="(detail) in order.detailArrayList" :key="detail.skuId">
          <li>
    ...
    <div class="sub clearFix">
      <a class="subBtn" @click="submitOrder" href="javascript:;">提交订单</a>
    </div>
  </div>
</template>
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        ...
        orderDetailList: this.order.detailArrayList//商品信息
      }
