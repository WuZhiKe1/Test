        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 以前的路由跳转：从A跳B 
                  这里是在进行跳转之前发送请求把购买的产品信息通过请求的方式通知服务器，服务器进行存储
                -->
...
export default {
  ...
  computed: {
    ...
    //给子组件数据，防止数据加载过晚返回 undefined 加判断返回空[]
    //当返回空时没有 Url属性 需要在加一个空对象{}
    skuImageList() {
  ...
  methods: {
    ...
    async addShopcar() {
      ...
      try {
        ...
        //路由跳转还要将产品的信息带给下一级路由组件
        //一些简单的数据skuNum通过 query参数传递过去
        //产品信息比较复杂【ksuIfo】通过会话存储【不持久化，会话结束数据消失】
        //本地存储|会话存储 字符串
